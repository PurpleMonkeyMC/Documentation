...
当前等级数字代表您所到达的记录点数字，绿色的经验条会根据您与下一个记录点的距离来作出变化，
...
当遇到对您来说比较困难的跳跃时，恰当地使用原地练习道具进行过跳练习能够有效提高您通过困难跳跃的几率。

![practice.png](practice.png){width="500"}

在您触发开始跑酷的计时后或是在观察模式中，“原地练习”工具会出现在您快捷栏的7号位。
您可以手持它右键来进入原地练习状态。

![practice-1.png](practice-1.png){width="500"}

使用练习模式的时候，您当前的坐标和视角朝向将会被设置为最初的临时记录点。

进入练习模式后，您可以看到物品快捷栏和正常跑酷时有所不同，

位于5号位的工具“返回上一个记录点”用于返回进入练习模式后所设置的临时记录点。

![practice-2.png](practice-2.png){width="500"}

6号位工具“将此处设置为记录点”用于将您当前的坐标和视角朝向设置为新的临时记录点。

![practice-3.png](practice-3.png){width="500"}

7号位工具“退出练习模式”用于退出练习模式，**退出时的位置以最初的临时记录点为准。**
...
在您开始跑酷之前，您可以使用物品快捷栏7号位“灵魂PK”工具与已经通过该跑酷地图的玩家进行灵魂对决，
踩下跑酷踏板后，该名玩家就会根据通关录像进行移动，每次跑酷开始之前只能选择其中一位玩家。
